...
echo -e "\e[31m"
read -p "Bi kod salla ama unutma gadam: " islem
if [[ $islem == "insta01" ]]; then
sleep 1
echo ""
echo -e "\e[33mKomutan Logar bir cisim yaklaşıyor...."
sleep 2
echo -e "\e[37m"
...
cat Game/Site-lol/lol.txt
	...
	clear
        echo -e "\e[31mYanlışla gardeş...."
	sleep 3
        bash code.sh
fi
echo -e "\e[31m"
read -p "Bizde R olmaz ama sen yapıcaksan bilemem (ENTER)" non
cd ..
bash tst.sh